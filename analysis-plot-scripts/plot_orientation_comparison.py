...
print(f"In-medium run: {rundir_deven}")
print(f"In-vacuum run: {rundir_nodev}")
...
def load_run_info(runpath):
    ...
    if os.path.exists(tdir) and os.path.isdir(tdir):
        dirname = tdir
    elif (tdir := os.path.join(dirname, "state_info")) and (os.path.exists(tdir) and os.path.isdir(tdir)):
        dirname = tdir
    else:
