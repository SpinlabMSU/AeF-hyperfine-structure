#!/usr/bin/env python3
## baf_state.py -- implements code relating to the hyperfine structure of 138BaF
## This code is neither fast nor implements the various matrix elements properly
